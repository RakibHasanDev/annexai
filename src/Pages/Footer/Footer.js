...
const Footer = () => {
    return (
        <div>
            ...
            <footer className="bg-gray-200 text-gray-700 py-2 px-4">
                <div className="md:flex justify-between items-center">
                    <div>
                        <ul className="self-center py-6 space-y-4 text-center sm:flex sm:space-y-0 sm:justify-around sm:space-x-4 lg:flex-1 lg:justify-start border-2">
                            <li>Shop</li>
                            <li>About</li>
                            <li>Blog</li>
                            <li>Pricing</li>
                    ...
                    <div className='border-2 text-center'>
                        <p>
                            ©Powered by <span className='font-semibold'>AnneAXI</span>
                        </p>
                    </div>

                    
                    <div className="flex flex-col justify-center pt-6 lg:pt-0 items-center">
